...
export default function App() {
  ...
  const [sortMode, setSortMode] = useState("date"); // "date" | "location"
  ...
  function isOnSelectedDate(ev, isoDate) {
    if (!isoDate) return true; // no date selected -> show all
    if (!ev.date) return false;
    const evISO = toISOFromMMDDYYYY(ev.date); // convert from "MM/DD/YYYY"
